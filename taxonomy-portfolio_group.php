					...
					<div id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
						...
						<div class="post-content">
							...
							<div class="post-meta">
								...
								<p>
									<span class="author">By <?php the_author_posts_link(); ?></span><span class="post-date"> on <?php the_time( 'F jS, Y' ); ?></span><span class="categories"> in <?php echo get_the_term_list( get_the_ID(), 'portfolio_group', '', ', ', '' ); ?></span>
									<?php global $post; ?>
