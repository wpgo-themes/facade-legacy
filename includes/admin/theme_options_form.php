...
<div class="wrap pc_settings">
	...
	<h2 class="options-title">Facade Pro Theme Options</h2>

	<div id="pc-buttons">
		<a class="button-secondary pc-lower" href="http://www.presscoders.com/facade-setup" target="_blank">Theme Setup Tutorials</a>
	...
	if ( isset( $_POST['reset_options'] ) ) {
		...
		?>
		<div class="error">
			<p><?php printf( __( '%s theme options have been reset!', 'presscoders' ), PC_THEME_NAME ); ?></p></div>
		<?php
	...
	if ( isset( $_GET['settings-updated'] ) && ! isset( $_POST['reset_options'] ) ) {
		?>
		<div class="updated"><p><?php printf( __( '%s theme options updated!', 'presscoders' ), PC_THEME_NAME ); ?></p>
		</div>
		<?php
	...
	<form name="<?php echo PC_THEME_NAME_SLUG; ?>_options_form" method="post" action="options.php">
		...
		<div id="pc-options-wrap">
			...
			<div class="ltinfo">
				...
				<p class="description"><?php _e( 'Customize your site colors, and column layout for posts/pages.', 'presscoders' ); ?></p>
			</div>
			<!-- .ltinfo -->
			...
			<div class="rtoptions">
				...
				<div class="box">
					<a class="button-secondary" href="<?php echo get_admin_url( '', "customize.php" ); ?>">Theme Customizer</a>&nbsp;&nbsp;<?php _e( 'Add a custom logo, change theme colors, fonts, and more', 'presscoders' ); ?>
				</div>
			</div>
			<!-- .rtoptions -->
			...
			<div style="display:none;" class="rtoptions">
				...
				<?php
				/* Don't output favicon if not set. */
				$favicon = ( empty( $favicon ) ) ? '<em>(none set)</em>' : '<img src="' . $favicon . '" width="16" height="16" />';
				?>
				<p class="description"><?php _e( 'Current active favicon image', 'presscoders' ); ?>: <?php echo $favicon; ?></p>
			</div>
			<!-- .rtoptions -->
			...
			<div class="ltinfo">
				...
				<p class="description"><?php _e( 'Various options that affect the theme appearance.', 'presscoders' ); ?></p>
			</div>
			<!-- .ltinfo -->
			...
			<div class="ltinfo">
				...
				<p class="description"><?php _e( 'The contact form page template sends emails to this address.', 'presscoders' ); ?></p>
			</div>
			<!-- .ltinfo -->

			<div class="rtoptions">
				<div class="box">
					<label><?php _e( 'Admin E-mail:', 'presscoders' ); ?>
						<input type="text" class="gray" style="width: 220px;" name="<?php echo PC_OPTIONS_DB_NAME; ?>[<?php echo PC_ADMIN_EMAIL_TEXTBOX; ?>]" value="<?php echo $options[PC_ADMIN_EMAIL_TEXTBOX]; ?>" />
