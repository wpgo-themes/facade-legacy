			...
			<div class="<?php echo PC_Utility::content_layout_classes_primary(); ?>">
				...
				<div id="main">
					<div>
						...
						<div>
							<p>
								<?php _e( 'Apologies, but the page you trying to reach does not exist, or has been moved. Why not try going back to the ', 'presscoders' ) ?>
								<a href="<?php echo home_url(); ?>"><?php _e( 'home page', 'presscoders' ) ?></a><?php _e( ', using the menus, or searching for something more specific?', 'presscoders' ) ?>
							</p>
